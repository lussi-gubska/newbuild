...
<? include ($_SERVER ['DOCUMENT_ROOT']."/clent/block_slider.php");?>
<!--slider END-->

<? include ($_SERVER ['DOCUMENT_ROOT']."/clent/block_preim.php");?>
       
<? include ($_SERVER ['DOCUMENT_ROOT']."/clent/block_gallery.php");?>
       
<? include ($_SERVER ['DOCUMENT_ROOT']."/clent/block_services.php");?>
       
<? include ($_SERVER ['DOCUMENT_ROOT']."/clent/block_mtext.php");?>
